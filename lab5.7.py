...
customer_data_without_zip = [(customer_names[i], customer_ids[i], shopping_points[i]) for i in range(min(len(customer_names),len(customer_ids),len(shopping_points)))]

print("List of tuples without using zip():")
print(customer_data_without_zip)